...
def create_secret_keyboard():
    keyboard = types.InlineKeyboardMarkup()
    button_github = types.InlineKeyboardButton(text='Ссылка на GitHub', callback_data='/gitHub')
    button_vk = types.InlineKeyboardButton(text='Ссылка на вк', callback_data='/vk')
    button_sert = types.InlineKeyboardButton(text='Свидетельство', callback_data='/sert')
    button_down = types.InlineKeyboardButton(text='Главное меню', callback_data='/main')
    keyboard.add(button_github, button_vk, button_sert, button_down)
    return keyboard
...
def create_voice_keyboard():
    ...
    button_love = types.InlineKeyboardButton(text='История первой любви', callback_data='/f_love')
    button_down = types.InlineKeyboardButton(text='Главное меню', callback_data='/main')
